...
function buildProviderButtons(available, selected, hasInitialQueries) {
	return [
		...
		},
		{
			value: "exa",
			label: "Exa",
			available: available.exa
		},
		{
			value: "brave",
			label: "Brave",
			available: available.brave
		},
		{
			value: "parallel",
			label: "Parallel",
			available: available.parallel
		},
		{
			value: "tavily",
			label: "Tavily",
			available: available.tavily
		},
		{
			value: "perplexity",
			label: "Perplexity",
...
//#endregion
export { generateCuratorPage };

//# sourceMappingURL=curator-page-B0-gxNAo.mjs.map